...
export const DashboardMonterrey = () => {
    ...
    return (
        <div className="h-fit sm:h-full bg-white">
            <div className='grid grid-cols-8 bg-auto bg-center h-full bg-cover w-full h-full m-0' style={{ backgroundImage: `url(${BrokenClouds})` }}>
                <div className='col-span-8 sm:col-span-6 grid grid-cols-3 m-4'>
                ...
                <div className="col-span-8 sm:col-span-2 overflow-x-scroll whitespace-nowrap sm:whitespace-normal scroll w-full bg-gray-100 bg-opacity-50 p-4  sm:pt-10">
